  ...
  return (
    <div className="mx-auto max-w-6xl space-y-12 px-5 pb-24 pt-28">
      ...
      <section className="card-dark p-6 space-y-4">
        ...
        <p className="text-sm text-muted">
          Hier past u de tekst aan. Die gaat mee via WhatsApp, e-mail en als titel onder de foto op
          Facebook. Op de telefoon kunt u Facebook kiezen in het deelmenu; op de computer plakt u de
          tekst nog even boven de foto (Cmd+V).
        </p>
